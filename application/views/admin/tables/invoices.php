...
if (@get_module_info('branches')->active == 1) { 
    ...
    if(isset($user_branches[0])){
        ...
        array_push($where, 'AND '. db_prefix(). 'invoices.branches_id IN (' . implode(', ', $user_branches) . ')');
    }else{
        
        array_push($where, 'AND '. db_prefix(). 'invoices.branches_id > 0');
    }
}
...
$result = data_tables_init($aColumns, $sIndexColumn, $sTable, $join, $where, [
    ...
    db_prefix() . 'invoices.branches_id',
