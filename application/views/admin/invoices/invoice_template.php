...
<div class="panel_s invoice accounting-template">
    ...
    <div class="panel-body">
        ...
        <div class="row">
            ...
            <?php if (@get_module_info('branches')->active == 1) {
               $selected = (isset($invoice) ? $invoice->branches_id : '');

               if (is_admin()) {
                  $branches = getResultArray('branches');
               } else {
               }
               $branches = user_branches(get_staff_user_id());
               echo render_select('branches_id', $branches, array('id', 'branch'), 'invoice_branches_id', $selected);
            } ?>
               ...
               ?>
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <span class="input-group-addon invoice_prefix">
                            <?php if (isset($invoice)) { ?>
        ...
        <div class="table-responsive s_table">
            <table class="table invoice-items-table items table-main-invoice-edit has-calculations no-mtop">
                <thead>
                  ...
                  <th width="10%" align="right"><?php echo _l('invoice_table_quantity2_heading'); ?></th>
                ...
                <tbody>
                  ...
                  <td>
                     <input type="number" name="quantity2" class="form-control" placeholder="<?php echo _l('item_quantity2_placeholders'); ?>">
                     <input type="text" placeholder="<?php echo _l('unit'); ?>" data-toggle="tooltip" data-title="e.q kg, lots, packs" name="quantity_unit" class="form-control input-transparent text-right">
                  </td>
                        <td></td>
                        <td>
                            <?php
                    ...
                    <?php if (isset($invoice) || isset($add_items)) {
                     ...
                     if (!$item['quantity_unit']) {
                        $unit_placeholder = _l('quantity_unit');
                        $item['quantity_unit'] = '';
                     }

                     $table_row .= '<input type="text" placeholder="' . $unit_placeholder . '" name="' . $items_indicator . '[' . $i . '][quantity_unit]" class="form-control input-transparent text-right" value="' . $item['quantity_unit'] . '">';
                     $table_row .= '</td>';
