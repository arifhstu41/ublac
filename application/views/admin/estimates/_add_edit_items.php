    ...
    <div class="table-responsive s_table">
        <table class="table estimate-items-table items table-main-estimate-edit has-calculations no-mtop">
            <thead>
               ...
               <th width="10%" align="right"><?php echo _l('estimate_table_quantity2_heading'); ?></th>
            ...
            <tbody>
               ...
               <td>
                  <input type="number" name="quantity2" min="0" value="1" class="form-control" placeholder="<?php echo _l('item_quantity_placeholder'); ?>">
                  <input type="text" placeholder="<?php echo _l('unit'); ?>" name="quantity_unit" class="form-control input-transparent text-right">
               </td>
                    <td></td>
                    <td>
                        <?php
