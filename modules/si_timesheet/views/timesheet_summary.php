				...
				<div class="panel_s">
					<div class="panel-body">
						...
						<div class="row">
							...
							<div class="col-md-2 border-right form-group">
								<label for="hide_columns" class="control-label"><span class="control-label"><?php echo _l('si_ts_hide_export_columns'); ?></span></label>
							...
							<?php
								...
								<?php if((is_admin() || has_permission('si_timesheet','','view')) && $staff_id=='')//display staff only if multi staff task is showing
								{
									...
									<?php foreach($months_cols as $month_key=>$cols){
											$col_val=(isset($task[$month_key])?"<span class='label label-default-light pull-left mright5' data-toggle='tooltip' data-title='".$cols."'><i class='fa fa-clock-o'></i> ".seconds_to_time_format($task[$month_key])."</span>":'');
											echo "<td>$col_val</td>";
