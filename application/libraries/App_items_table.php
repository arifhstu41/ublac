...
class App_items_table extends App_items_table_template
{
    ...
    public function items()
    {
        ...
        foreach ($this->items as $item) {
            ...
            $itemHTML .= '<td class="quantity" align="right" width="' . $regularItemWidth . '%">' . $item['quantity'] . '</td>';
    ...
    public function html_headings()
    {
        ...
        $html .= '<th align="right">' . _l('invoice_table_quantity_heading') . '</th>';
    ...
    public function pdf_headings()
    {
        ...
        $tblhtml .= '<th width="' . $regularItemWidth . '%" align="right">' ._l('invoice_table_quantity_heading') . '</th>';
